...
abstract class $UserDetailsCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String username, String email, String? connectionId});
}
...
class _$UserDetailsImpl implements _UserDetails {
  ...
  @override
  String toString() {
    return 'UserDetails(id: $id, username: $username, email: $email, connectionId: $connectionId)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, username, email, connectionId);
...
abstract class _UserDetails implements UserDetails {
  const factory _UserDetails(
      ...
      final String? connectionId}) = _$UserDetailsImpl;
